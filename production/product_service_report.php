  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-weight:800;">Service Use Report</h3>
      </div>
                        ...
                        <tbody>
                            ...
                            foreach ($objects as $role_data) {
                                ...
                                <tr><td><?php echo $count ?></td>
                                    <td><?php echo strtoupper($role_data->code) ?></td>
                                    
                                    <?php
                                        for($i=0; $i<12; $i++) {
                                          $mon = array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"); 
                                          $checkObjects = ProductUsageServices::find_by_code_month_and_year($role_data->code,$mon[$i],$_GET['year']);
                                        ...
                                        $checkCodeYear = ProductUsageServices::find_code_and_year($role_data->code,$_GET['year']);
