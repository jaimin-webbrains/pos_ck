  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-weight:800;">Stock Write Off</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"><?php echo (empty($data->id)) ? 'Add' : 'Edit'; ?> Stock Write Off</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form id="formRole" action="proccess/stock_write_off_sales_process.php" method="post" class="form-horizontal form-label-left">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="WriteOff ..." id="stock_write_off" name="writeoff" value="<?php echo $data->write_off_quantity; ?>" onkeyup="checkWriteOff(this.value)" required="">
                </div>
