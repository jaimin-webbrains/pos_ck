  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR PRODUCT USED REPORT - (Date)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
            <form class="form-inline" method="post" action="colour_product_used_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR PRODUCT USED REPORT - (Month)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="colour_product_used_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12"> 
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR PRODUCT USED REPORT - (Year)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="colour_product_used_report.php">
            ...
            <table class="table table-bordered" id="report_table">
              <thead>
                ...
                <?php
                  ...
                  if(isset($_POST['from_date']) && isset($_POST['to_date']) && $error_count == 0){ 
                    $to_date = strtotime("+1 day", strtotime($_POST['to_date']));
              ...
              <tbody>
                ...
                if(isset($_POST['search_year']) && !isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $item_type_s = 2;
                    $s_quantity = Reports::find_S_R_colour_usage_by_year_branch_month_wise($_POST['search_year'], $branch_id, $p_code->code, $item_type_s);
                    if(!empty($s_quantity)){
                      foreach($s_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
                      }
                    }else{
                    ...
                    $item_type_r = 4;
                    $r_quantity = Reports::find_S_R_colour_usage_by_year_branch_month_wise($_POST['search_year'], $branch_id, $p_code->code, $item_type_r);
                    if(!empty($r_quantity)){
                      foreach($r_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
                      }
                    }else{
                ...
                if(isset($_POST['search_year']) && isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $item_type_s = 2;
                    $s_quantity = Reports::find_S_R_colour_usage_by_year_branch_month_day_wise($_POST['search_month'],$_POST['search_year'], $branch_id, $p_code->code, $item_type_s);
                    if(!empty($s_quantity)){
                      foreach($s_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
                    ...
                    $r_quantity = Reports::find_S_R_colour_usage_by_year_branch_month_day_wise($_POST['search_month'],$_POST['search_year'], $branch_id, $p_code->code, $item_type_r);
                    if(!empty($r_quantity)){
                      foreach($r_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
                ...
                if(isset($_POST['from_date']) && isset($_POST['to_date']) && $error_count == 0){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $item_type_s = 2;
                    $s_quantity = Reports::find_S_R_colour_usage_by_year_branch_day_wise( $_POST['from_date'],$to_date, $branch_id, $p_code->code, $item_type_s);
                    if(!empty($s_quantity)){
                      foreach($s_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
                    ...
                    // $to_date = date("Y-m-d", $to_date);
                    // print_r($to_date);
                    $r_quantity = Reports::find_S_R_colour_usage_by_year_branch_day_wise( $_POST['from_date'],$to_date, $branch_id, $p_code->code, $item_type_r);
                    if(!empty($r_quantity)){
                      foreach($r_quantity as $qty){
                        echo "<td style='text-align:center;'>".$qty."</td>";
                        $stock_sale_total_qty += $qty ;
