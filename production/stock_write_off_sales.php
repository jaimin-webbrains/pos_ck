...
if (isset($_POST["id"])) {
  $data = StockWriteOffSales::find_by_id($_POST["id"]);
} else {
  $data = new StockWriteOffSales();
}
?>
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-weight:800;">Stock WriteOff Sales</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"><?php echo (empty($data->id)) ? 'Add' : 'Edit'; ?> Stock Write Off Sales</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form id="formRole" action="proccess/stock_write_off_sales_process.php" method="post" class="form-horizontal form-label-left">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  <label>Reasons</label>
                  <input type="text" class="form-control" placeholder="Reasons ..." id="stock_reasons" name="reasons" value="<?php echo $data->reasons; ?>" onkeyup="checkReasons(this.value)" required="">
                </div>

                <div class="form-group">
                  <label>WriteOff Quantity</label>
                  <input type="number" class="form-control" placeholder="WriteOff Quantity..." id="stock_write_off" name="writeoff" value="<?php echo $data->write_off_quantity; ?>" onkeyup="checkWriteOff(this.value)" required="">
                </div>
                ...
                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                  <?php if(Functions::check_privilege_by_module_action("StockWriteOffSales", "ins")) { ?>
                    <div class=" col-md-4 col-sm-4 col-xs-12">
                      <button id="btnSave" type="button" name="save" class="btn btn-block btn-success"><i class="fa fa-floppy-o"></i>&nbsp;Save</button>
                    </div>
                  <?php } ?>
                  <?php if(Functions::check_privilege_by_module_action("StockWriteOffSales", "del")){ ?>
                  ...
                  <?php } ?>
                  <div class=" col-md-4 col-sm-4 col-xs-12">
                    <a href="stock_write_off.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i>&nbsp;Reset</button></a>
                  </div>
                </div>
              </div>
            </form>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                  $objects = StockWriteOffSales::find_all();
                  $count = 0;
                  foreach ($objects as $obj) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $obj->write_off_quantity ?></td>
                      <td><?php echo $obj->reasons ?></td>
                      <td><?php echo $obj->datetime ?></td>
                    <td>
                      <form action="stock_write_off.php" method="post" style="float: left;">
...
function getFormErrors(){
  ...
  element = $("#stock_writeoff");
  element_value = element.val();
  if (element_value === "") {
    errors.push("Stock WriteOff - cannot be empty");
    element.css({"border": "1px solid red"});
  } else  {
    element.css({"border": "1px solid #ccc"});
  }
