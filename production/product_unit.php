...
if (!(isset($_POST["id"]) && $role = ProductUnit::find_by_id($_POST["id"]))) {
  $role = new ProductUnit();
}
?>
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-weight:800;">Product Use</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"><?php echo (empty($role->id)) ? 'Add' : 'Edit'; ?> Product Use</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form id="formRole" action="proccess/product_unit_process.php" method="post" class="form-horizontal form-label-left">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                  ...
                  <?php } ?>
                  <div class=" col-md-4 col-sm-4 col-xs-12">
                    <a href="product_unit.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i>&nbsp;Reset</button></a>
                  </div>
                </div>
              </div>
            </form>
                ...
                <tbody>
                  ...
                  foreach ($objects as $role_data) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $role_data->p_unit ?></td>
                      <td></td>
                    <td>
                      <form action="product_unit.php" method="post" style="float: left;">
