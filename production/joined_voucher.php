  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - JOINED MONTH VOUCHER - </h2>
            ...
            <div class="x_content">
              ...
              <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                  $this_month = date('m');
                  foreach(Customer::find_all_customer_joinday($this_month) as $cus_data){
                    echo "<tr>";
              ...
              <button type="submit" name="joined" class="btn btn-primary btn-block">SEND </button>
            </form>
            <!-- form ends -->
