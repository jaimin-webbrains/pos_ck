              ...
              <form id="formRole" action="proccess/package_category_process.php" method="post" class="form-horizontal form-label-left" >
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                    <?php if(Functions::check_privilege_by_module_action("Packge_Category","ins")){ ?>
                    ...
                    <?php } ?>
                    <?php if(Functions::check_privilege_by_module_action("Packge_Category","del")){ ?>
            ...
            <div class="x_content">
              <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  $objects = PackageCategory::find_all();
                  $count = 0;
