...
if (isset($_POST["id"]) && $role = EpaymentOperator::find_by_id($_POST["id"])) {
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 style="font-weight:800;">E-Payment Operator </h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title" style="font-weight:700;"> E-Payment Operator </h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/epayments_process.php" method="post" class="form-horizontal form-label-left" >
                    ...
                    <div class="x_content">
                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $count = 0;
                                $objects = EpaymentOperator::find_all();
                                ...
                                foreach ($objects as $role_data) {
                                  ++$count;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="epayments.php" method="post" style="float: left;">
...
//        });
    ...
    $("#btnSave").click(function () {
        ...
        if (id) {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "E-Payment", "upd")) {
                FormOperations.confirmSave(validateForm(), "#formRole", id, null);
            }
        } else {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "E-Payment", "ins")) {
                FormOperations.confirmSave(validateForm(), "#formRole", id, null);
            }
        }
    });
    ...
    $("#btnDelete").click(function () {
        ...
        if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "E-Payment", "del")) {
