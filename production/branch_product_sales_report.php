  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - BRANCH PRODUCT SALES REPORT - (Date)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
            <form class="form-inline" method="post" action="branch_product_sales_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - BRANCH PRODUCT SALES REPORT - (Month)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="branch_product_sales_report.php">
            ...
            <div class="form-group" style="margin-right:30px;">
                ...
                <div>
                  <input type="radio" name="allbranches_2" id="allbranches_all_2" value="all" checked/>
                  <label for="allbranches_all_2">Yes</label>
                  <input type="radio" name="allbranches_2" id="allbranches_one_2" value="one" style="margin-left:30px;"/>
              ...
              <div class="form-group" style="margin-right:30px;">
                ...
                <div>
                  <select class="form-control" name="branch_id_2" id="branch_id_2">
                  <?php
                    foreach(Branch::find_all() as $branch){
                      echo "<option value='".$branch->id."' $selected>".$branch->name."</option>";
                    }
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - BRANCH PRODUCT SALES REPORT - (Year)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="branch_product_sales_report.php">
            <div class="form-group" style="margin-right:30px;">
                ...
                <div>
                  <input type="radio" name="allbranches_3" id="allbranches_all_3" value="all" checked/>
                  <label for="allbranches_all_3">Yes</label>
                  <input type="radio" name="allbranches_3" id="allbranches_one_3" value="one" style="margin-left:30px;"/>
              ...
              <div class="form-group" style="margin-right:30px;">
                ...
                <div>
                  <select class="form-control" name="branch_id_3" id="branch_id_3">
                  <?php
                    foreach(Branch::find_all() as $branch){
                      echo "<option value='".$branch->id."' $selected>".$branch->name."</option>";
                    }
          ...
          <div class="x_content" style="overflow-x:auto;">
            ...
            <table class="table table-bordered" id="report_table">
              ...
              <tbody>
                ...
                $branch_id = isset($_POST['branch_id_3']) ? $_POST['branch_id_3']: 0;
                if(isset($_POST['search_year']) && !isset($_POST['search_month'])  && isset($branch_id)){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockReceive = Reports::get_quantity_by_year_branch('StockProductSales', $_POST['search_year'],$branch_id, $p_code->code);
                    echo "<td style='text-align:center;'>".$StockReceive."</td>";
                  
                    $StockSale = Reports::get_quantity_by_year_month_wise_year($_POST['search_year'], $p_code->code, $branch_id);
                    // print_r($StockSale);
                    // die;
                    ...
                    $stock_balance = $StockReceive -( $stock_sale_total_qty + $StockRotate + $StockRotateUsage + $StockWaveoff + $StockWaveoffUsage + $StockTransferUsage);
                ...
                if(isset($_POST['search_year']) && isset($_POST['search_month']) && isset($branch_id)){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockReceive = Reports::get_quantity_by_month_year_branch('StockProductSales',$_POST['search_month'], $_POST['search_year'],$branch_id, $p_code->code );
                    echo "<td style='text-align:center;'>".$StockReceive."</td>";

                    $StockSale = Reports::get_quantity_by_year_month_day_wise_Sales($_POST['search_month'], $_POST['search_year'], $p_code->code, $branch_id);
                ...
                if(isset($_POST['from_date']) && isset($_POST['to_date']) && $error_count == 0 && isset($branch_id)){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    // print_r("SELECT * FROM invoice_sub INNER JOIN invoice ON invoice_sub.invoice_id = invoice.id WHERE invoice_sub.item_type = 1 AND invoice_sub.code = '111' AND DATE(invoice.invoice_date) BETWEEN '2021-05-21' AND '2021-05-30' ");
                    $StockSale = Reports::get_quantity_day_wise_Sales($_POST['from_date'], $_POST['to_date'], $p_code->code, $branch_id);
                    //date
                    // print_r($StockSale);
                    // die;
