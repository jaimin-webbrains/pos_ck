  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - SELECTED VOUCHER - </h2>
        ...
        <div class="x_panel">
          <div class="x_content">
            ...
            <form action="proccess/voucher_process.php" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" name="select" class="btn btn-primary btn-block">SEND </button>
            </form>
