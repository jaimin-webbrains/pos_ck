                        ...
                        <form id="formRole" action="proccess/role_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" id="txtName" name="name" onkeyup="showHint(this.value)" value="<?php echo $role->name; ?>" required="">
...
function showHint(str) {
  if (str.length == 0) {
    ...
    xmlhttp.open("GET", "proccess/data_check.php?role=" + str, true);
    xmlhttp.send();
  }
}
