            ...
            <form id="formRole" action="proccess/colour_process.php" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data" >
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" maxlength="60" class="form-control" placeholder="Colour Code" id="txtName" name="code" value="<?php echo $role->code; ?>" required="">
                </div>

                <div class="form-group">
                  <label>Description</label>
                  <input type="text" class="form-control" placeholder="description" id="txtName" name="description" value="<?php echo $role->description; ?>" onkeyup="showHint(this.value)" required="">
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              foreach ($objects as $role_data) {
                ...
                foreach(ColourBranch::find_by_colour_id($role_data->id) as $colour_branch_data ){
                  echo $colour_branch_data->branch_id()->name." / ";
                }
