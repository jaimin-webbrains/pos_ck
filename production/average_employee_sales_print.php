...
<html lang="en">
<head>
  <title>Average & Employee Report</title>
  <meta charset="utf-8">
        ...
        <table id="tblData" class="table table-bordered" style="font-size:10px;width:100%;">
          <thead>
            ...
            <tr>
              ...
              echo "<th style='text-align:center;'>Average Spending</th>";
...
$avg_spending = 0;
if($total_head1 != 0){
    $avg_spending = $total_sum/$total_head1;
}
echo "<td style='text-align:center;'> ".number_format($avg_spending,2)." </td>";
