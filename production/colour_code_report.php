  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR CODE REPORT - (Branch & Date)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
            <form class="form-inline" method="post" action="colour_code_print.php" target="_blank">
              <?php                  
      ...
      <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR CODE REPORT - (Branch & Month)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
      ...
      <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - COLOUR CODE REPORT - (Branch & Year)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
