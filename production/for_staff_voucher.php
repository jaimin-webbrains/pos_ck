  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - FOUR STAFF VOUCHER (BY MONTH) - </h2>
          ...
          <div class="x_panel">
            <div class="x_content">
              ...
              <form action="proccess/voucher_process.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="voucher_qty">VOUCHER QUANTITY:</label>
                  <input type="number" name="voucher_qty" class="form-control" id="voucher_qty">
                </div>
                <div class="form-group">
              ...
              <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  foreach(User::find_all() as $staff_data){
                    echo "<tr>";
                    echo "<td>".$staff_data->name."</td>";
                    echo "<td style='text-align:right;'>";
                    echo '<div class="form-group">
                    <div class="checkbox">
                    <label><input type="checkbox" name="staff'.$staff_data->id.'" value="1"> SELECT</label>
                    </div>
                    </div>';
                    echo "</td>";
                    echo "</tr>";
              ...
              <button type="submit" name="staff" class="btn btn-primary btn-block">SEND </button>
            </form>
            <!-- form ends -->
