  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK TRANSFER REPORT - (Date)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
            <form class="form-inline" method="post" action="stock_transfer_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK TRANSFER REPORT - (Month)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="stock_transfer_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK TRANSFER REPORT - (Year)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="stock_transfer_report.php">
            ...
            <table class="table table-bordered" id="report_table">
              <thead>
                ...
                <tr>
                  ...
                  <th style='text-align:center;' <?php echo $colspan;?>>Stock Transfer</th>
                </tr>
                <tr>
                  <th></th>
                  <th></th>
              ...
              <tbody>
                ...
                if(isset($_POST['search_year']) && !isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockTransfer = Reports::get_stock_transfer_quantity_by_year_month_wise('StockTransfer', $_POST['search_year'], $branch_id, $p_code->code);
                    for($month=1; $month<=12; $month++){
                      echo "<td style='text-align:center;'>".$StockTransfer[$month]."</td>";
                      $stock_sale_total_qty += $StockTransfer[$month] ;
                    }
                ...
                if(isset($_POST['search_year']) && isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockTransferUsage = Reports::get_stock_transfer_quantity_by_branch_year_month_day_wise('StockTransfer', $_POST['search_month'], $_POST['search_year'], $branch_id, $p_code->code);
                    for($day = 1; $day <= $days_in_month; $day++){
                      echo "<td style='text-align:center;'>".$StockTransferUsage[$day]."</td>";
                    }
                ...
                if(isset($_POST['from_date']) && isset($_POST['to_date']) && $error_count == 0){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockTransferUsage = Reports::get_stock_transfer_quantity_by_branch_day_wise('StockTransfer', $_POST['from_date'], $_POST['to_date'], $branch_id,$p_code->code);
                     foreach($StockTransferUsage as $key=>$value){
