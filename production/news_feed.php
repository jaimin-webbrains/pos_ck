  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-weight:800;">RSS Feed</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"><?php echo (empty($role->id)) ? 'Add' : 'Edit'; ?> RSS Feed </h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form id="formRole" action="proccess/news_ticker_process.php" method="post" class="form-horizontal form-label-left" >
              <div class="col-md-12 col-sm-12 col-xs-12">
                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $role->id; ?>" />
                <div class="form-group">
                  <label>RSS Feed</label>
                  <small style="color:red;"> </small>
                  <input type="text" class="form-control" placeholder="Feed" id="txtName" name="name" value="<?php echo $role->content; ?>" required="">
                </div>
          ...
          <div class="x_content">
            <table id="" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <?php
                $objects = NewsTicker::find_all();
                foreach ($objects as $role_data) {
                  ?>
                  <tr>
                    <td><?php echo $role_data->id ?></td>
                    <td><?php echo $role_data->content ?></td>
                    <td>
                      <form action="news_feed.php" method="post" style="float: left;">
