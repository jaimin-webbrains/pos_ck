  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK ROTATE REPORT - (Date)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- form start -->
            <form class="form-inline" method="post" action="stock_rotate_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK ROTATE REPORT - (Month)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="stock_rotate_report.php">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 id="title" style="font-weight:700;"> - STOCK ROTATE REPORT - (Year)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-inline" method="post" action="stock_rotate_report.php">
            ...
            <table class="table table-bordered" id="report_table">
              <thead>
                ...
                <tr>
                  ...
                  <th style='text-align:center;' <?php echo $colspan;?>>Stock Rotate Sale</th>
                  <th style='text-align:center;' <?php echo $colspan;?>>Stock Rotate Usage</th>
                </tr>
                <tr>
                  <th></th>
                  <th></th>
              ...
              <tbody>
                ...
                if(isset($_POST['search_year']) && !isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockRotateSales = Reports::get_quantity_by_branch_year_month_wise('StockRotateSales', $_POST['search_year'], $branch_id, $p_code->code);
                    for($month=1; $month<=12; $month++){
                      echo "<td style='text-align:center;'>".$StockRotateSales[$month]."</td>";
                      $stock_sale_total_qty += $StockRotateSales[$month] ;
                    }

                    $StockRotateUsage = Reports::get_quantity_by_branch_year_month_wise('StockRotateUsage', $_POST['search_year'], $branch_id, $p_code->code);
                    for($month=1; $month<=12; $month++){
                      echo "<td style='text-align:center;'>".$StockRotateUsage[$month]."</td>";
                      $stock_sale_total_qty += $StockRotateUsage[$month] ;
                    }
                ...
                if(isset($_POST['search_year']) && isset($_POST['search_month'])){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockRotateSales = Reports::get_quantity_by_branch_year_month_day_wise('StockRotateSales', $_POST['search_month'], $_POST['search_year'], $branch_id, $p_code->code);
                    for($day = 1; $day <= $days_in_month; $day++){
                      echo "<td style='text-align:center;'>".$StockRotateSales[$day]."</td>";
                    }

                    $StockRotateUsage = Reports::get_quantity_by_branch_year_month_day_wise('StockRotateUsage', $_POST['search_month'], $_POST['search_year'], $branch_id, $p_code->code);
                    for($day = 1; $day <= $days_in_month; $day++){
                      echo "<td style='text-align:center;'>".$StockRotateUsage[$day]."</td>";
                    }
                ...
                if(isset($_POST['from_date']) && isset($_POST['to_date']) && $error_count == 0){
                  ...
                  foreach($p_codes as $p_code){
                    ...
                    $StockRotateSales = Reports::get_quantity_by_branch_day_wise('StockRotateSales', $_POST['from_date'], $_POST['to_date'], $branch_id,$p_code->code);
                    foreach($StockRotateSales as $key=>$value){
                      echo "<td style='text-align:center;'>".$value."</td>";
                    }

                    $StockRotateUsage = Reports::get_quantity_by_branch_day_wise('StockRotateUsage', $_POST['from_date'], $_POST['to_date'], $branch_id,$p_code->code);
                    foreach($StockRotateUsage as $key=>$value){
                      echo "<td style='text-align:center;'>".$value."</td>";
                    }
