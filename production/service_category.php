                    ...
                    <div class="x_content">
                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $objects = ServiceCategory::find_all();
                                $count = 0;
...
//        });
    ...
    $("#btnSave").click(function () {
        ...
        if (id) {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Service_Category", "upd")) {
                FormOperations.confirmSave(validateForm(), "#formRole", id, null);
            }
        } else {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Service_Category", "ins")) {
                FormOperations.confirmSave(validateForm(), "#formRole", id, null);
            }
        }
    });
    ...
    $("#btnDelete").click(function () {
        ...
        if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Service_Category", "del")) {
