...
class User extends DatabaseObject{
    ...
    protected static $db_fk=array("user_status_id"=>"UserStatus","designation_id"=>"Designation","branch_id"=>"Branch");
...
//    public $image;
    ...
    public static function check_contact($value){
        ...
        $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE contact_no LIKE '%$value%' ");
        return $object_array;
    }
...
//    }
    ...
    public static function find_all_service_branch($value){
      global $database;
      $value=$database->escape_value($value);
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE designation_id= 5 AND branch_id = '$value' ");
      return $object_array;
    }

    public static function find_all_service_branchs(){
      global $database;
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE designation_id= 5 ");
      return $object_array;
    }
