...
class StockProductSales extends DatabaseObject{
    public static $table_name = "stock_product_sales";
    ...
    public static function find_stock_sale_by_code_date($start_date,$end_date,$p_code){
        global $database;
    ...
    public static function find_stock_sale_by_code_month($month,$year,$p_code){
      global $database;
