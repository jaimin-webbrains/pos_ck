...
class StockRotateUsage extends DatabaseObject{
    public static $table_name = "stock_rotate_usage";
    ...
    public static function find_stock_rotate_usage_by_code_date($start_date,$end_date,$p_code){
        global $database;
    ...
    public static function find_stock_rotate_usage_by_code_month($month,$year,$p_code){
      global $database;
    ...
    public static function find_stock_rotate_usage_by_dates_code_branch($start_date,$end_date,$branch_id,$p_code) {
      global $database;
      $start_date = $database->escape_value($start_date);
      $end_date = $database->escape_value($end_date);
    ...
    public static function find_stock_rotate_usage_by_code_month_branch($month,$year,$branch_id,$p_code) {
      global $database;
      $month = $database->escape_value($month);
      $year = $database->escape_value($year);
      $branch_id = $database->escape_value($branch_id);
