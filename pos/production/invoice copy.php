              ...
              <tbody style="min-height:400px;overflow:auto;">
                ...
                foreach($invoice_object as $invoice_sub_data){
                  ...
                  if(($invoice_sub_data->item_type == 2) || ($invoice_sub_data->item_type == 4)){
                    ...
                    if(!empty($check)){
                      echo "<td><input class='form-control' type='text' placeholder= 'tubecode 1' name='color' style='width: 100px;'></td>";
                      echo "<td><input class='form-control' type='number' placeholder='%' name='percentage' /></td>";

                        echo "<tr><td colspan='8'></td>
                        <td><input class='form-control' type='text' placeholder= 'tubecode 2' name='color2' style='width: 100px;'></td>";
                        echo "<td><input class='form-control' type='number' placeholder='%' name='percentage2' /></td></tr>
                        <tr><td colspan='8'></td>
                        <td><input class='form-control' type='text' placeholder= 'tubecode 3' name='color3' style='width: 100px;'></td>";
                        echo "<td><input class='form-control' type='number' placeholder='%' name='percentage3' /></td></tr>";
                        echo "<tr><td colspan='8'></td>
                        <td><input class='form-control' type='text' placeholder= 'tubecode 4' name='color4' style='width: 100px;'></td>";
                        echo "<td><input class='form-control' type='number' placeholder='%' name='percentage4' /></td></tr>
                        <tr><td colspan='8'></td>
                        <td><input class='form-control' type='text' placeholder= 'tubecode 5' name='color5' style='width: 100px;'></td>";
                        echo "<td><input class='form-control' type='number' placeholder='%' name='percentage5' /></td></tr>";
                    }
                  }
