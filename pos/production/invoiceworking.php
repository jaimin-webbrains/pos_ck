            ...
            <table class="table table-striped grid-table">
              ...
              <tbody style="min-height:400px;overflow:auto;">
                ...
                foreach($invoice_object as $invoice_sub_data){
                  ...
                  echo "<td><form method='post' action='proccess/invoice_process.php' > <input type='hidden' name='invoice_id' value='".$_GET['invoice_id']."' /><input type='hidden' name='row_qty_ops' value='".$invoice_sub_data->id."' /> <select name='ops1'>";
                  ...
                  echo " </select> <button type='submit' style='padding:10px;' class='btn btn-primary btn-xl'><i class='fa fa-pencil-square-o' aria-hidden='true'></i> </button> </form></td>";
                  echo "<td><a href='proccess/invoice_process.php?invoice_row_delete=".$invoice_sub_data->id."&&invoice_id=".$_GET['invoice_id']."' style='padding:10px;' class='btn btn-xl btn-danger'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                  echo "</tr>";
