  ...
  if(isset($_POST['color'])){
    ...
    if(count($checkCodeExists) > 0){
      ...
      if($_POST['color5'] == '') {
        ...
        {
          if(($_POST['color'] == $_POST['color2']) || ($_POST['color'] == $_POST['color3']) || ($_POST['color2'] == $_POST['color3']) || ($_POST['color'] == $_POST['color3']) || ($_POST['color'] == $_POST['color4']) || ($_POST['color'] == $_POST['color4']) || ($_POST['color4'] == $_POST['color5']))
          {
