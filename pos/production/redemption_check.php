            ...
            <tbody>
              ...
              if(count($redeem_obj) > 0){
                foreach($redeem_obj as $redeem_data){
                  $invoice = Invoice::get_invoice_by_id($redeem_data->invoice_id);
                  if($invoice){
                    $inv_num = $invoice[0]->invoice_number;
                    $date = explode(' ',$invoice[0]->invoice_date)[0];
                  }else{
                    $inv_num = '-';
                    $date = '-';
                  }

                  $invoice_sub = InvoiceSub::find_all_invoice_id($redeem_data->invoice_id);
                    $cat = '';
                    if($invoice_sub){
                  ...
                  <tr>
                    ...
                    <td style='text-align:center;'><?php echo $inv_num ?></td>
                    ...
                    <td style='text-align:center;'><?php echo $cat; ?></td>
                  </tr>
                  <?php
                }
              }else{
