...
class Queue extends DatabaseObject{
    ...
    public static function find_by_type_last_customer($value,$value2){
      ...
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE customer_id='$value' AND status < 2  AND DATE(que_date_time)='$value2' ORDER BY id DESC LIMIT 1 ");
    ...
    public static function find_all_today_branch($value,$value2){
      ...
      $value=$database->escape_value($value);
      $value2=$database->escape_value($value2);
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE DATE(que_date_time)='$value' AND branch_id = '$value2' ORDER BY id DESC ");
      return $object_array;
    }
    ...
    public static function find_all_today_branch_pending_creative($value,$value2){
      ...
      $value=$database->escape_value($value);
      $value2=$database->escape_value($value2);
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE DATE(que_date_time)='$value' AND branch_id = '$value2' AND status = 1 AND queue_type = 'creative' ORDER BY id ASC ");
      return $object_array;
    }
    ...
    public static function find_all_today_branch_pending_stylist($value,$value2){
      ...
      $value=$database->escape_value($value);
      $value2=$database->escape_value($value2);
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE DATE(que_date_time)='$value' AND branch_id = '$value2' AND status = 1 AND queue_type = 'stylist' ORDER BY id ASC ");
      return $object_array;
    }
    ...
    public static function find_all_today_branch_pending_online($value,$value2){
      ...
      $value=$database->escape_value($value);
      $value2=$database->escape_value($value2);
      $object_array=self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE DATE(que_date_time)='$value' AND branch_id = '$value2' AND status = 1 AND queue_type = 'online' ORDER BY id ASC ");
      return $object_array;
    }
