...
//update code
    ...
    require_once __DIR__."/../modal/Advertisment.php";
    require_once __DIR__."/../modal/NewsTicker.php";
    require_once __DIR__."/../modal/ProductCategory.php";
    require_once __DIR__."/../modal/Invoice.php";
   
    require_once __DIR__."/../modal/InvoiceSub.php";
    require_once __DIR__."/../modal/Colour.php";
    require_once __DIR__."/../modal/ColourBranch.php";
    ...
    require_once __DIR__."/../modal/Voucher.php";
    require_once __DIR__."/../modal/RewardPoint.php";
    require_once __DIR__."/../modal/Referral.php";
    require_once __DIR__."/../modal/BranchWorkingTime.php";
    require_once __DIR__."/../modal/FeedBack.php";
    require_once __DIR__."/../modal/StockReceive.php";
    require_once __DIR__."/../modal/StockProductSales.php";
    require_once __DIR__."/../modal/StockProductUsage.php";
    require_once __DIR__."/../modal/StockWriteOffSales.php";
    require_once __DIR__."/../modal/StockWriteOffUsage.php";
    require_once __DIR__."/../modal/StockRotateSales.php";
    require_once __DIR__."/../modal/StockRotateUsage.php";
